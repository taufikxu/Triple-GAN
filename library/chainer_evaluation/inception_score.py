...
def inception_accuracy(model, ims, labels, batch_size=100, splits=10):
    ...
    if isinstance(ims, (list, tuple)):
        ...
        for ims in ims_list:
            ...
            print(
                "batch_size:{}, n_ims{}, n_batches{}".format(batch_size, n, n_batches)
            )
                    ...
                    (
                        ...
                        Tower(
                            [
                                ...
                                (
                                    "conv_1",
                                    L.Convolution2D(192, 320, 3, stride=2, pad=0),
                                ),
                    ...
                    (
                        ...
                        Tower(
                            [
                                ...
                                (
                                    "conv_3",
                                    L.Convolution2D(192, 192, 3, stride=2, pad=0),
                                ),
                                ("bn_conv_3", L.BatchNormalization(192)),
                                ("_relu_3", F.relu),
                            ]
                    ...
                    (
                        ...
                        Tower(
                            [
                                (
                                    "conv",
                                    L.Convolution2D(1280, 320, 1, stride=1, pad=0),
                                ),
                    ...
                    (
                        ...
                        Tower(
                            [
                                (
                                    "conv",
                                    L.Convolution2D(1280, 384, 1, stride=1, pad=0),
                                ),
                                ("bn_conv", L.BatchNormalization(384)),
                                ("_relu", F.relu),
                                (
                    ...
                    (
                        ...
                        Tower(
                            [
                                (
                                    "conv",
                                    L.Convolution2D(1280, 448, 1, stride=1, pad=0),
                                ),
                                ("bn_conv", L.BatchNormalization(448)),
                                ("_relu", F.relu),
                                (
                                    "conv_1",
                                    L.Convolution2D(448, 384, 3, stride=1, pad=1),
                                ),
                    ...
                    (
                        ...
                        Tower(
                            [
                                ...
                                (
                                    "conv",
                                    L.Convolution2D(1280, 192, 1, stride=1, pad=0),
                                ),
                                ("bn_conv", L.BatchNormalization(192)),
                                ("_relu", F.relu),
                            ]
                    ...
                    (
                        ...
                        Tower(
                            [
                                (
                                    "conv",
                                    L.Convolution2D(2048, 320, 1, stride=1, pad=0),
                                ),
                                ("bn_conv", L.BatchNormalization(320)),
                                ("_relu", F.relu),
                            ]
                    ...
                    (
                        ...
                        Tower(
                            [
                                (
                                    "conv",
                                    L.Convolution2D(2048, 384, 1, stride=1, pad=0),
                                ),
                                ("bn_conv", L.BatchNormalization(384)),
                                ("_relu", F.relu),
                                (
                    ...
                    (
                        ...
                        Tower(
                            [
                                (
                                    "conv",
                                    L.Convolution2D(2048, 448, 1, stride=1, pad=0),
                                ),
                                ("bn_conv", L.BatchNormalization(448)),
                                ("_relu", F.relu),
                                (
                    ...
                    (
                        ...
                        Tower(
                            [
                                ...
                                (
                                    "conv",
                                    L.Convolution2D(2048, 192, 1, stride=1, pad=0),
                                ),
                                ("bn_conv", L.BatchNormalization(192)),
                                ("_relu", F.relu),
                            ]
