...
def loss_entropy_ssl(netC, x_l, l, x_u):
    return loss_cross_entropy(netC, x_l, l) + FLAGS.alpha_entropy * loss_entropy_reg(netC, x_u)

loss_dict = {"crossentropy": loss_cross_entropy, "entropyreg":loss_entropy_reg, , "entropyssl":loss_entropy_ssl}