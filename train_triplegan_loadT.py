...
old_model_c = FLAGS.old_model_c
FLAGS.old_model_c = "Loaded"
GPUS = FLAGS.gpu
dirname = os.path.dirname(old_model_c)
basename = os.path.basename(old_model_c)
...
checkpoint_io.load_file(old_model_c)
...
cur_iter = int(os.path.splitext(basename)[0][5:])

for i in range(cur_iter, max_iter + pretrain_inter):
